...
async function loadQuality() {
  ...
  // regen-themes.yml). It's optional: a fetch failure or schema mismatch
  // returns an empty record and the gallery silently skips badges, so an
  // older Pages snapshot without the file still renders.
  try {
