...
if select_cloud:
    ...
    for index, item in enumerate(command):
        if item == 'model_provider="qwen_flash_local"':
            ...
            command[index] = 'model_catalog_json="/Users/example/.local/share/qwen-flash/cloud-flash-models.json"'
    ...
    duplicate_catalog = ('model_catalog_json="/tmp/conflicting-models.json"'
                         ...
                         'model_catalog_json="/Users/example/.local/share/qwen-flash/cloud-flash-models.json"')
...
class PaperLauncherTests(unittest.TestCase):
    def setUp(self):
        ...
        real_queue = 'QUEUE = Path("/Users/example/.local/bin/qwen-implementation-queue")'
    ...
    def test_valid_task_uses_flash_by_default_and_preserves_status(self):
        ...
        self.assertIn('model_catalog_json="/Users/example/.local/share/qwen-flash/cloud-flash-models.json"', args)
