# PaperPilot backend Qwen implementation worker
...
Use existing AbstractSource/AbstractSignal/AbstractExporter/AbstractLLMProvider patterns where applicable. Preserve typing, public API docstrings and shared HTTP/retry/rate-limit utilities. Validate untrusted API/LLM output against schemas. Test changed failure paths (such as 429, timeout, malformed data, deduplication or reruns) with deterministic mocks.
